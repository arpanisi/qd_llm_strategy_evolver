"""Seed 2 / Island 2 (Volatility): inverse-20d-vol, weekly.

Each week, weight each asset inversely proportional to its trailing 20-day
annualized realized volatility; renormalized to sum to 1.
"""
