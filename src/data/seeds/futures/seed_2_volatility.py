"""Seed 2 / Island 2 (Volatility, futures variant): inverse-20d-vol, weekly.

Each week, weight each instrument inversely proportional to its trailing
20-day annualized realized volatility, converted to whole contracts.
"""
